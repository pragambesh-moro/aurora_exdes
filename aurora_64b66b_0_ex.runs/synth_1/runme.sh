...
HD_PWD='c:/Research/aurora_64b66b_0_ex/aurora_64b66b_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ps_aurora_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ps_aurora_wrapper.tcl
