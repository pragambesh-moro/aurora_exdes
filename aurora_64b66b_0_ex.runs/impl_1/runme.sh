...
HD_PWD='c:/Research/aurora_64b66b_0_ex/aurora_64b66b_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ps_aurora_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ps_aurora_wrapper.tcl -notrace
